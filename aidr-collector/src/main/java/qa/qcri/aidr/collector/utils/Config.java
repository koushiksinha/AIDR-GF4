...
public class Config {
	...
	//TODO: Replace with config file in text format
        ...
        public static final String FETCHER_REST_URI="http://localhost:8080/AIDRCollector/webresources/";
        ...
        public static final String PERSISTER_REST_URI="http://localhost:8080/AIDRPersister/webresources/";
