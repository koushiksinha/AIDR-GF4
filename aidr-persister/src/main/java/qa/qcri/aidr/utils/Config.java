...
public class Config {
	...
	//TODO: Replace with config file in text format
        ...
        //public static final String SCD1_URL = "http://scd1.qcri.org/aidr/data/persister/";
        public static final String SCD1_URL = "http://localhost/aidr/data/persister/";		// gf 3 way modified
